import { lineupStudents } from "../index";

describe("Suzuki needs help lining up his students!", () => {
  it("Should return the list of names in descending order.", () => {
    const tests = [
      {
        params: {
          names:
    ...
    for (let { params, output } of tests) {
      expect(lineupStudents(params.names).toString()).toBe(output.toString());
    }
  });
});
